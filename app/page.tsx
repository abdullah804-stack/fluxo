...
export default function Home() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-page font-sans">
      <main className="flex w-full max-w-3xl flex-col items-center justify-between bg-page px-16 py-32 sm:items-start">
        <Image
        ...
        <div className="flex flex-col gap-4 text-base font-medium sm:flex-row">
          ...
          <a
            className="flex h-12 w-full items-center justify-center rounded-full border border-line px-5 text-ink transition-colors hover:border-line-strong hover:bg-surface md:w-[158px]"
